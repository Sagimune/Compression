...
#include "../../HuffmanCompression/mypushbutton.h"
...
void mypushbutton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (mypushbutton::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mypushbutton::myclicked)) {
                *result = 0;
                return;
            }
        }
